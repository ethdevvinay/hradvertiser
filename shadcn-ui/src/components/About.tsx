      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <p>
                ...
                in the world of printing. For over{" "}
                <span className="text-orange-600 font-semibold">15 years</span>,
                we've been transforming ideas into
                <span className="text-blue-600 font-semibold">
                  {" "}
                  stunning visual realities
                </span>
                .
              </p>
              ...
              <p>
                ...
                and operated by a team of
                <span className="text-pink-600 font-semibold">
                  {" "}
                  passionate professionals
                </span>{" "}
                who understand that every print tells a story.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 ${feature.bg} rounded-xl flex items-center justify-center shadow-lg ${
                    ...
                    <span
                      className={`font-semibold ${feature.color} ${
          ...
          <div className="relative">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 group-hover:scale-105 transition-all duration-500">
                <div className="text-center mb-6">
                  <img
                    src="/images/Logo.jpg"
                    alt="Haryana Advertiser Company Logo"
                    loading="lazy"
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="flex flex-wrap justify-center gap-3 mt-6">
                    ...
                    <div className="flex items-center gap-2 bg-gradient-to-r from-pink-500 to-red-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                      ⭐ 4.9/5 Reviews
                    </div>
                  </div>
                </div>
            ...
            {/* Floating Stats (hidden on small devices) */}
            <div className="hidden md:block absolute -top-8 -left-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-2xl p-4 shadow-xl animate-float">
            ...
            <div className="hidden md:block absolute -bottom-8 -right-8 bg-gradient-to-r from-pink-500 to-red-500 text-white rounded-2xl p-4 shadow-xl animate-float delay-1000">
              <div className="text-center">
            ...
            <div className="hidden md:block absolute top-1/2 -right-12 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-2xl p-4 shadow-xl animate-float delay-500">
              <div className="text-center">
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-3xl p-1 shadow-2xl max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl p-8">
              ...
              <button
                aria-label="Start WhatsApp chat for printing services"
                onClick={() => {
                  const message =
                    "Hi! I'm interested in your premium printing services. Please tell me more about what you can create for me.";
                  const whatsappUrl = `https://wa.me/919802919872?text=${encodeURIComponent(
                    message
                  )}`;
