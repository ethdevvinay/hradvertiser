            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
              ...
              <div className="lg:col-span-4">
                <div className="relative p-6 bg-gradient-to-br from-slate-800/40 to-purple-900/30 rounded-2xl backdrop-blur-sm border border-purple-500/20 hover:border-purple-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20">
                  ...
                  {/* Rohtak Office */}
                  <div className="mb-8">
                    <h5 className="text-xl font-bold mb-4 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent flex items-center">
                      🏢 Rohtak Office
                    </h5>
                    <div className="space-y-3">
                      ...
                      <div className="group flex items-center gap-3 p-2 rounded-xl hover:bg-gradient-to-r hover:from-slate-700/30 hover:to-purple-700/30 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                          onClick={() => window.open('mailto:hradvertiser92@gmail.com')}>
                        <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                          <span className="text-lg group-hover:animate-pulse">✉️</span>
                        </div>
                        <div>
                          <span className="text-gray-200 group-hover:text-white font-medium">hradvertiser92@gmail.com</span>
                          <div className="text-sm text-blue-400">🚀 Send Email</div>
                        </div>
                      </div>
                      
                      <div className="group flex items-start gap-3 p-2 rounded-xl hover:bg-gradient-to-r hover:from-slate-700/30 hover:to-purple-700/30 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                          onClick={() => window.open('https://maps.google.com/?q=Wakilon+Wali+Gali+Shant+Mai+Chowk+Jhajjar+Road+Rohtak+Haryana+124001')}>
                        <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-violet-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                          <span className="text-lg group-hover:animate-pulse">📍</span>
                        </div>
                        <div>
                          <span className="text-gray-200 group-hover:text-white font-medium text-sm leading-relaxed">
                  ...
                  {/* Gurgaon Office */}
                  <div>
                    <h5 className="text-xl font-bold mb-4 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent flex items-center">
                      🏙️ Gurgaon Office
                    </h5>
                    <div className="space-y-3">
                      <div className="group flex items-center gap-3 p-2 rounded-xl hover:bg-gradient-to-r hover:from-slate-700/30 hover:to-purple-700/30 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                      ...
                      <div className="group flex items-center gap-3 p-2 rounded-xl hover:bg-gradient-to-r hover:from-slate-700/30 hover:to-purple-700/30 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                          onClick={() => window.open('mailto:hradvertiserggn@gmail.com')}>
                        <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                          <span className="text-lg group-hover:animate-pulse">✉️</span>
                        </div>
                        <div>
                          <span className="text-gray-200 group-hover:text-white font-medium">hradvertiserggn@gmail.com</span>
                          <div className="text-sm text-blue-400">🚀 Send Email</div>
                        </div>
                      </div>
                      
                      <div className="group flex items-start gap-3 p-2 rounded-xl hover:bg-gradient-to-r hover:from-slate-700/30 hover:to-purple-700/30 transition-all duration-300 transform hover:scale-105 cursor-pointer"
                          onClick={() => window.open('https://maps.google.com/?q=392/12+Near+Shiv+Murti+Gurgaon+Haryana+122001')}>
                        <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-violet-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                          <span className="text-lg group-hover:animate-pulse">📍</span>
                        </div>
                        <div>
